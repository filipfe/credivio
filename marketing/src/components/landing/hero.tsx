...
export default function Hero({ dict }: { dict: Dict["landing"]["hero"] }) {
  ...
  return (
    <section className="bg-primary-dark sm:px-6 flex flex-col items-center gap-8 overflow-hidden relative pb-4">
      <div className="relative max-w-7xl mx-auto z-10 flex flex-col gap-4 items-center py-12 lg:py-24 w-full sm:rounded-lg border border-white/10 bg-gradient-to-br from-[rgba(255,255,255,0.05)] to-[rgba(255,255,255,0)]">
        <div className="px-6 flex flex-col gap-4 items-center">
          <h1 className="text-4xl max-w-lg lg:text-6xl text-white text-center font-black lg:max-w-3xl">
            {title}
          </h1>

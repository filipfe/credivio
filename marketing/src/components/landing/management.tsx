  ...
  return (
    <section className="bg-light py-16">
      ...
      <div className="mx-auto mt-16 grid max-w-sm grid-cols-1 gap-6 text-gray-500 md:max-w-3xl md:grid-cols-2 xl:grid-rows-2 md:grid-rows-3 xl:max-w-6xl xl:auto-rows-fr xl:grid-cols-3">
        <div className="group relative items-start overflow-hidden bg-white border p-6 rounded-2xl">
          <div>
        ...
        <div className="group relative items-start overflow-hidden bg-white border p-6 rounded-2xl order-3 xl:order-none">
          <div>
            <h3 className="font-semibold mb-2 text-primary">
            ...
            <p className="text-foreground">
              ...
              and strict privacy protocols, ensuring your information remains
              confidential.
            </p>
          </div>
          <svg
        ...
        <div className="group relative items-start overflow-hidden bg-white border p-6 rounded-2xl md:row-span-2">
          <div>
            <h3 className="font-semibold mb-2 text-primary">
        ...
        <div className="group relative items-start overflow-hidden bg-white p-6 rounded-2xl flex-row order-4 md:col-span-2 md:flex-row xl:order-none border">
          <div>
            <h3 className="font-semibold mb-2 text-primary">

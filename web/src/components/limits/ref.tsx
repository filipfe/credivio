...
export default function LimitRef({ amount, currency }: Limit) {
  const percentage = Math.min(Math.max(24 / amount, 0), 1); // clamp percentage between 0 and 1
      ...
      <div className="relative w-full pb-[50%] overflow-visible">
        ...
        >
          ...
          <path
            d="M 5,50 A 45,45 0 0 1 95,50" /* Slightly adjust start and end points */
            fill="none"
            stroke={percentage >= 0.5 ? "#fdbb2d" : "#177981"}
            strokeWidth="8" /* Decrease stroke width */
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-2 flex flex-col items-center gap-1">
